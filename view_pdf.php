...
// LEFT JOIN so paper shows even if author_id doesn't match a user
// COALESCE tries p.author_name first (manually uploaded), then u.name (registered author)
$stmt = $pdo->prepare("
    SELECT p.*, 
...
// Set page title and Google Scholar citation meta tags
